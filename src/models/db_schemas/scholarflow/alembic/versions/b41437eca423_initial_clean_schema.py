...
Revision ID: b41437eca423
Revises:
Create Date: 2026-07-12 09:13:21.870629
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("asset_project_id", sa.String(), nullable=False),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.text("now()"),
    ...
    op.create_table(
        ...
        sa.Column("chunk_project_id", sa.String(), nullable=False),
