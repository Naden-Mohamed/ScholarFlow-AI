...
from ..VectorDBEnums import (DistanceMetric, PgVectorDistanceMethodEnums, PgVectorIndexTypeEnums, PgVectorTableSchemeEnums)
import logging
...
class PGVectorProvider(VectorDBInterface):
    ...
    def __init__(self, db_client, default_vector_size: int = 786,
                       distance_method: str = "", index_threshold: int=100):
